...
final class DeserializationProviderTest extends TestCase
{
    public function testRegister()
    {
        ...
        self::assertInstanceOf(UrlEncodedTypeDecoder::class, $container['deserializer.decodertypes'][1]);
        self::assertInstanceOf(XmlTypeDecoder::class, $container['deserializer.decodertypes'][2]);
