...
/**
 * @covers \Chubbyphp\Deserialization\Denormalizer\Relation\Doctrine\EmbedManyFieldDenormalizer
 */
class EmbedManyFieldDenormalizerTest extends TestCase
{
    ...
    {
        $parent = $this->getParent();
        $parent->setChildren(new ArrayCollection([$this->getChild()]));
    ...
    {
        $parent = $this->getParent();
        $parent->setChildren(new ArrayCollection([$this->getDoctrineProxyChild()]));
